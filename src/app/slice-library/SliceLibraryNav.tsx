...
function NavElementLibrary({ library }: { library: SliceLibrary }) {
  return (
    ...
    >
      {({ open }) => (
        <>
          <DisclosureButton className="group flex w-full items-center rounded-md bg-white py-2 pr-2 text-left text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:outline-hidden">
            <svg
              className={clsx(
...
function NavElementSlice({
  ...
  return (
    ...
    >
      {({ open }) => (
        <>
          <DisclosureButton className="group flex w-full items-center rounded-md bg-white py-2 pr-2 pl-[2rem] text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900">
            <svg
              className={clsx(
                open ? 'rotate-90 text-gray-400' : 'text-gray-300',
          ...
          <DisclosurePanel className="space-y-1">
            {slice.variations.map((variation) => (
              <a
                ...
                className="group flex w-full items-center rounded-md py-2 pr-2 pl-20 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900"
              >
                {variation.name}
              </a>
            ))}
